...
const LevelScript level_test_entry[] = {
	...
	AREA(1, test_area_1),
		...
		OBJECT(MODEL_NONE, 3158, -2008, 2100, 0, 0, 0, 0x00000000, bhvOnOffBlock),
		OBJECT(MODEL_NONE, 3158, -2008, 1800, 0, 0, 0, (1 << 16), bhvOnOffBlock),
		OBJECT(MODEL_NONE, 3158, -2008, 1500, 0, 0, 0, 0x00000000, bhvOnOffBlock),
		MARIO_POS(0x01, 0, -314, 471, 280),
		OBJECT(MODEL_ONOFF_SWITCH, 2729, -2153, 2031, 0, 0, 0, 0x00000000, bhvOnOffButton),
		OBJECT(MODEL_ONOFF_SWITCH, 2729, -2153, 1616, 0, 0, 0, (1 << 16), bhvOnOffButton),
